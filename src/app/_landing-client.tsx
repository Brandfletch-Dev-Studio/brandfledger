  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-5 h-16 flex items-center justify-between">
          ...
          <div>
            <Link
              href="/dashboard"
              className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold transition-colors shadow-sm"
            >
              Get Started
            </Link>
          </div>
      ...
      <main className="flex-1 flex flex-col">
        <section className="max-w-5xl mx-auto px-5 pt-20 pb-12 text-center flex flex-col items-center">
          {/* Pill Badge at top */}
          <div
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold text-indigo-600 mb-6 shadow-sm"
        ...
        {/* ── FEATURES SECTION ── */}
        <section id="features" className="max-w-5xl mx-auto px-5 pt-8 pb-20 w-full">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-1">Profit Tracking</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-1">Invoicing</h3>
